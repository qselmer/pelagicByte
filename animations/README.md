...
Self-contained marine creative-coding pieces. Each directory contains its own `index.html`, `styles.css`, and `script.js` so that experiments can be opened, copied, or revised independently.
